...
#' estimate_sample
#' 
#' A function to estimate sample size for UNHCR Corporate survey
#' 
#' The function conveniently:  
#' 
#'   * Map the UNHCR statistical category to the sampling universe category to 
...
#'             If the data is not yet available for that year 
#'             (aka still in the mid year reporting stage),
#'              it will automatically fall back on the previous year
#' @param pop_type Vector of character values.  Possible population types :
#' 
#'            *  RAS  - aka REF+ASY+OIP, Refugees, Asylum-seeker and other in 
#'              Need of International Protection -  "Pillar-1-Refugee"
#'              
...
#' 
#' 
#' @importFrom ForcedDisplacementStat
